...
def argparser():
    parser = argparse.ArgumentParser("Pytorch version of Res_Swin")
    parser.add_argument('--epochs', help='the total episodes', type=int, default=11000)  # data 1 can be about 2000
    ...
    parser.add_argument('--model', help='model type', type=str, default="res_swin", choices=["red_cnn", "unet34", "unet50","model1","model2","res_swin_v1", "res_swin_v2","transunet","res_swin"])
